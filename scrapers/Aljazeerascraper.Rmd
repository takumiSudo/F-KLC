...
```{r}
# make sure to change when saving data
setwd("C:/Users/luukb/OneDrive/Documents/AUC/PC&DA/Project/data")
```
...
```{r}
write.csv(articles, "data/aljazeera_articles.csv", row.names = FALSE)
```
